define(["require", "exports"], function (require, exports) {
    ...
    const data = {
        ...
        resources: {
            water: { mass: 40, mine: { tics: 1, value: 13 } },
            ore: { mass: 70, mine: { tics: 2, value: 17 } },
            minerals: { mass: 60, mine: { tics: 2, value: 22 } },
            hydrocarbons: { mass: 20, mine: { tics: 2, value: 45 } },
            food: { mass: 20, mine: { tics: 2, value: 100 }, recipe: { tics: 3, materials: { water: 2, hydrocarbons: 2 } } },
            fuel: { mass: 1, recipe: { tics: 1, materials: { ore: 1, water: 1 } } },
            luxuries: { mass: 20, recipe: { tics: 5, materials: { water: 2, ore: 1, minerals: 1, hydrocarbons: 2 } } },
            metal: { mass: 80, recipe: { tics: 2, materials: { ore: 3 } } },
            ceramics: { mass: 50, recipe: { tics: 2, materials: { minerals: 3 } } },
            medicine: { mass: 10, recipe: { tics: 3, materials: { food: 1, hydrocarbons: 2 } } },
            machines: { mass: 70, recipe: { tics: 3, materials: { metal: 2 } } },
            electronics: { mass: 40, recipe: { tics: 3, materials: { ceramics: 5 } } },
            cybernetics: { mass: 120, recipe: { tics: 4, materials: { machines: 2, electronics: 2 } } },
            narcotics: { mass: 10, recipe: { tics: 2, materials: { medicine: 1, hydrocarbons: 1, water: 1 } }, contraband: 5 },
            weapons: { mass: 30, recipe: { tics: 4, materials: { metal: 4, ceramics: 1 } }, contraband: 7 },
        },
        market: {
            fabricators: 10,
            minability: 0.1,
            produces: {},
            consumes: { water: 3, food: 2, medicine: 0.5, narcotics: 0.1, weapons: 0.2 },
        },
        traits: {
            ...
            'agricultural': { produces: { food: 4, hydrocarbons: 1 }, consumes: { machines: 0.5, fuel: 0.5, water: 2, hydrocarbons: 2 }, price: { food: 0.75, hydrocarbons: 1.5, water: 1.25 } },
            'habitable': { produces: { food: 8, hydrocarbons: 3 }, consumes: { food: 4, narcotics: 0.25, weapons: 0.5 }, price: { food: 0.5, hydrocarbons: 0.5, water: 1.25 } },
      ...
      `,
        ...
        shipclass: {
            /* Civilian */
            shuttle: { hull: 2, armor: 1, cargo: 6, hardpoints: 1, mass: 6000, tank: 1, drives: 6, drive: 'ion', restricted: false, desc: '' },
            schooner: { hull: 4, armor: 2, cargo: 14, hardpoints: 1, mass: 16000, tank: 3, drives: 14, drive: 'ion', restricted: false, desc: '' },
            cutter: { hull: 6, armor: 3, cargo: 20, hardpoints: 2, mass: 24000, tank: 5, drives: 20, drive: 'ion', restricted: false, desc: '' },
            /* Merchant */
            hauler: { hull: 6, armor: 2, cargo: 30, hardpoints: 2, mass: 30000, tank: 4, drives: 20, drive: 'ion', restricted: false, desc: '' },
            merchantman: { hull: 8, armor: 4, cargo: 40, hardpoints: 3, mass: 44000, tank: 6, drives: 30, drive: 'ion', restricted: false, desc: '' },
            freighter: { hull: 12, armor: 6, cargo: 50, hardpoints: 3, mass: 60000, tank: 8, drives: 60, drive: 'ion', restricted: false, desc: '' },
            /* Military */
            guardian: { hull: 8, armor: 6, cargo: 10, hardpoints: 3, mass: 36000, tank: 4, drives: 40, drive: 'ion', restricted: 'Friendly', markets: ['capital', 'military'], desc: '' },
            corvette: { hull: 10, armor: 10, cargo: 10, hardpoints: 4, mass: 24000, tank: 4, drives: 10, drive: 'fusion', restricted: 'Trusted', markets: ['capital', 'military'], desc: '' },
            cruiser: { hull: 20, armor: 15, cargo: 15, hardpoints: 8, mass: 56000, tank: 12, drives: 30, drive: 'fusion', restricted: 'Admired', markets: ['capital', 'military'], desc: '' },
            battleship: { hull: 30, armor: 20, cargo: 20, hardpoints: 10, mass: 85000, tank: 14, drives: 40, drive: 'fusion', restricted: 'Admired', markets: ['capital', 'military'], desc: '' },
            /* Faction ships */
            fortuna: { hull: 8, armor: 6, cargo: 60, hardpoints: 2, mass: 72000, tank: 8, drives: 70, drive: 'ion', restricted: 'Friendly', faction: 'JFT', desc: '' },
            neptune: { hull: 14, armor: 10, cargo: 40, hardpoints: 4, mass: 42000, tank: 10, drives: 50, drive: 'ion', restricted: 'Trusted', faction: 'TRANSA', markets: ['capital', 'military'], stealth: 0.05, desc: '' },
            barsoom: { hull: 20, armor: 20, cargo: 25, hardpoints: 5, mass: 21000, tank: 8, drives: 10, drive: 'fusion', restricted: 'Admired', faction: 'MC', markets: ['capital', 'military'], desc: '' },
            rockhopper: { hull: 6, armor: 4, cargo: 35, hardpoints: 3, mass: 32000, tank: 4, drives: 8, drive: 'fusion', restricted: 'Respected', faction: 'CERES', burn_rate: -0.015, desc: '' },
        },
        ship: {
            hull: { repair: 50 },
            armor: { repair: 200 },
