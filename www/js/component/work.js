define(function(require, exports, module) {
  ...
  Vue.component('work', {
    ...
    computed: {
      ...
      raise:      function() { return this.player.getStandingPriceAdjustment(this.place.faction) },
      place:      function() { return Game.game.here },
      tasks:      function() { return this.place.availableWorkTasks },
    ...
    methods: {
      getPayRate: function(task) {
        return this.place.payRate(this.player, task);
      },
